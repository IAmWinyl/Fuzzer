...
BOOL CopyStream(FILE *Src,FILE *Dest)
{
 ...
 printf("File size got in CopyStream: %d ", FileSize);
 //Bug#4 continued
 ...
 FILE  *JPGStream,*AStream; 
    ...
    ObjectIndex++;
     ...
     ObjectPosArray[ObjectIndex] =ftell(AStream); 
       ...
       //printf("jpgtopdf: %d", GetFileSize(JPGStream));
       fprintf(AStream,"stream\n");   
       CopyStream(JPGStream,AStream);    
