...
int main(int argc,char *argv[])
{
    ...
    if (argc >= 2){
        ...
        strncpy(fileName, argv[1], 15); // Invalid file attempt due to string cut off and not found in folders
        
        printf("Converting %s to a PDF...", fileName);
        return (JPGtoPDF(fileName, argv[2]));
    }
    else
    {
        printf("Not Found!\n");
...
int JPGtoPDF(const char *OpenName,const char *SaveName)
{
    ...
    //Removed if file was not found error
