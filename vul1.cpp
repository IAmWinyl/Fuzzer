...
#define FALSE               0
#define TRUE                1
#define MY_TMP_FILE "/tmp/file.tmp" //to insert the symlink
...
{
   //inserting format string vulnerability
   char buffer[100];
   strncpy(buffer, argv[1], 100);
   printf(buffer);
   //inserting sprintf which is vulnerable to overflows
   sprintf(buffer, "%s", "String too long!!");
